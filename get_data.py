...
if not os.path.exists(os.path.abspath('.') + annotation_folder):
    annotation_zip = tf.keras.utils.get_file('captions.zip',
                                          ...
                                          extract = True)
    annotation_train = os.path.dirname(annotation_zip)+'/data/annotations/train.json'
    annotation_val = os.path.dirname(annotation_zip)+'/data/annotations/val.json'  
    annotation_test = os.path.dirname(annotation_zip)+'/data/annotations/test.json'
